    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between">
            <div class="flex space-x-4">
                <a href="{{ route('admin.dashboard') }}" class="py-4 px-2 font-medium hover:text-purple-200 {{ request()->routeIs('admin.dashboard') ? 'border-b-2 border-white' : '' }}">
                ...
                <a href="{{ route('admin.dogs.index') }}" class="py-4 px-2 font-medium hover:text-purple-200 {{ request()->routeIs('admin.dogs.*') ? 'border-b-2 border-white' : '' }}">
